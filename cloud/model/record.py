...
'''
recordbasedir = r"C:\Users\derfei\Desktop\distribute cloud\disbributed-deep-learning-cloud\model\files"
from model.models import networkinfo
...
def writeapplication(tmpapplication):
    ...
    writeapplicationinfo(tmpapplicationdict['requestdeviceid'], tmpapplicationdict['applicationid'], tmpapplicationdict['taskidlist'],
                         tmpapplicationdict['formertasklist'], tmpapplicationdict['nexttasklist'], tmpapplicationdict['operationidlist'])



def writeapplicationinfo(requestdeviceid, applicationid, taskidlist, formertaskidlist,
    ...
    with open(filepath, "w+") as file:
        for i in range(0, len(taskidlist)):
            line = "{0}\t{1}\t{2}\t{3}\t{4}\t{5}\n".format(requestdeviceid, applicationid,
