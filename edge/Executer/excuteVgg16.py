...
class excuteVgg16:
    ...
    def __init__(self):
        ...
        operation3 = operation(3, self.__func3__, (28, 28, 256), weights_model)
        operation4 = operation(4, self.__func4__, (14, 14, 512), weights_model)
        operation5 = operation(5, self.__func5__, (7, 7, 512), weights_model)
